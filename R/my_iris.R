...
#'
#' The famous \code{\link[datasets]{iris}} dataest taken from the
#' \code{datasets} package to practice adding dataests to our R package.
#'
...
#' Gaspe Peninsula, \emph{Bulletin of the American Iris Society}, 59, 2-5.
"my_iris"
